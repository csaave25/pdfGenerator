...
export const dataInforme = {
    ...
    confiabilidad: {
        ...
        texto1Cliente: 'Capacidad de alertar oportunamente una grieta de criticidad alta en el entorno cercano del esparcidor (50 m) que comprometa su funcionamiento',
